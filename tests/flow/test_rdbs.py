...
def testRDBCompatibility():
    ...
    for fileName in RDBS:
        ...
        if(fileName == "1.4.9_with_avg_ctx.rdb"):
            ...
            assert r.execute_command('ts.info', 'ts1') == [b'totalSamples', 2, b'memoryUsage', 4248, b'firstTimestamp', 100, b'lastTimestamp', 120, b'retentionTime', 0, b'chunkCount', 1, b'chunkSize', 4096, b'chunkType', b'compressed', b'duplicatePolicy', None, b'ignoreMaxTimeDiff', 0, b'ignoreMaxValDiff', b'0', b'labels', [], b'sourceKey', None, b'rules', [[b'ts2', 1000, b'AVG', 0]]]
            assert r.execute_command('ts.info', 'ts2') == [b'totalSamples', 0, b'memoryUsage', 4184, b'firstTimestamp', 0, b'lastTimestamp', 0, b'retentionTime', 0, b'chunkCount', 1, b'chunkSize', 4096, b'chunkType', b'compressed', b'duplicatePolicy', None, b'ignoreMaxTimeDiff', 0, b'ignoreMaxValDiff', b'0', b'labels', [], b'sourceKey', b'ts1', b'rules', []]
